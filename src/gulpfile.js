...
gulp.task('styles:scss', function () {
    ...
    return gulp.src(['app/assets/styles/**/*.scss', '!app/assets/styles/components/components.scss'])
...
// Copy over compiled styles from .tmp to dist
...
gulp.task('html', function () {
    return gulp.src( ['app/**/*.html', 'app/**/*.php'] )
        .pipe($.useref.assets({searchPath: ['.tmp', 'app/assets']})) //{.tmp,app/assets}'}
...
gulp.task('serve', function () {
    ...
    gulp.watch(['app/assets/styles/**/*.{css,scss}'], ['styles']);
...
gulp.task('build', function (cb) {
    runSequence('styles', ['jshint', 'html', 'images', 'styles:build', 'scripts:build'], cb);
});
